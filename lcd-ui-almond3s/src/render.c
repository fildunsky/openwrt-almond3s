...
static const struct { uint16_t cp; uint8_t g[5]; } font5x7_sym[] = {
    ...
    /* Псевдографика рамок (одинарная и двойная) и блоки - ими рисуют меню
       консольные скрипты в LCD-терминале. Линии в клетке 6x8 идут с зазором
       в пиксель между соседями: шестая колонка и восьмая строка - поля. */
    { 0x2500, {0x08,0x08,0x08,0x08,0x08} },   /* box h */
    { 0x2502, {0x00,0x00,0x7F,0x00,0x00} },   /* box v */
    { 0x250C, {0x00,0x00,0x78,0x08,0x08} },   /* box dr */
    { 0x2510, {0x08,0x08,0x78,0x00,0x00} },   /* box dl */
    { 0x2514, {0x00,0x00,0x0F,0x08,0x08} },   /* box ur */
    { 0x2518, {0x08,0x08,0x0F,0x00,0x00} },   /* box ul */
    { 0x251C, {0x00,0x00,0x7F,0x08,0x08} },   /* box vr */
    { 0x2524, {0x08,0x08,0x7F,0x00,0x00} },   /* box vl */
    { 0x252C, {0x08,0x08,0x78,0x08,0x08} },   /* box dh */
    { 0x2534, {0x08,0x08,0x0F,0x08,0x08} },   /* box uh */
    { 0x253C, {0x08,0x08,0x7F,0x08,0x08} },   /* box vh */
    { 0x2550, {0x14,0x14,0x14,0x14,0x14} },   /* dbl h */
    { 0x2551, {0x00,0x7F,0x00,0x7F,0x00} },   /* dbl v */
    { 0x2554, {0x00,0x7C,0x04,0x74,0x14} },   /* dbl dr */
    { 0x2557, {0x14,0x74,0x04,0x7C,0x00} },   /* dbl dl */
    { 0x255A, {0x00,0x1F,0x10,0x17,0x14} },   /* dbl ur */
    { 0x255D, {0x14,0x17,0x10,0x1F,0x00} },   /* dbl ul */
    { 0x2560, {0x00,0x7F,0x00,0x77,0x14} },   /* dbl vr */
    { 0x2563, {0x14,0x77,0x00,0x7F,0x00} },   /* dbl vl */
    { 0x2566, {0x14,0x74,0x04,0x74,0x14} },   /* dbl dh */
    { 0x2569, {0x14,0x17,0x10,0x17,0x14} },   /* dbl uh */
    { 0x256C, {0x14,0x77,0x00,0x77,0x14} },   /* dbl vh */
    { 0x2580, {0x0F,0x0F,0x0F,0x0F,0x0F} },   /* upper half */
    { 0x2584, {0x70,0x70,0x70,0x70,0x70} },   /* lower half */
    { 0x2588, {0x7F,0x7F,0x7F,0x7F,0x7F} },   /* full block */
    { 0x2591, {0x2A,0x00,0x2A,0x00,0x2A} },   /* light shade */
    { 0x2592, {0x55,0x2A,0x55,0x2A,0x55} },   /* medium shade */
    { 0x2593, {0x7F,0x55,0x7F,0x55,0x7F} },   /* dark shade */
};
